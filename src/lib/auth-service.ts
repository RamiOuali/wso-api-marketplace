...
export class AuthService {
  ...
  async getUsername(): Promise<string> {
    ...
    if (userInfo) {
      // Remove or comment out this line to prevent repeated logging
    ...
    return user.profile.preferred_username || user.profile.email || user.profile.name || user.profile.sub || ""
  }
