export class WSO2ApiManagerService {
  ...
  constructor(
    baseUrl: string,
    clientId: string = 'HyoXELEpE6MIspK9nm_gRfDzR4Ea',
    clientSecret: string = 'vZT7AR0qzpGi7Mwo5KqhDnMS96wa'
  ) {
  ...
  async getAccessToken(): Promise<string> {
    ...
    try {
      ...
      params.append("scope", "openid apim:subscribe apim:api_key apim:app_manage apim:sub_manage apim:store_settings apim:sub_alert_manage apim:app_import_export apim:admin");
